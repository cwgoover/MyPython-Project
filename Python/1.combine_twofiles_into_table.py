...
def main():
    ...
    # http://stackoverflow.com/a/7605705/4710864
    ...
    # http://stackoverflow.com/a/27455446/4710864
...
def sort_dic(dic):
    # return sorted(dic.items(), lambda x: x[0])        # another way
...
def filter_file_by_stat(file_path):
    ...
    # regx = re.compile('adb.*?shell.+?(?=adb.*?shell|\Z)', re.MULTILINE | re.DOTALL)
    ...
    with open(file_path, 'r') as fp:
        ...
        # http://stackoverflow.com/a/5985841/4710864
...
def print_stats(data, non_intersection, dic1, dic2):
    ...
    with open(outfile, 'a') as the_file:
        ...
        # http://stackoverflow.com/a/3096984/4710864
        the_file.write('<tr>\n')
        the_file.write(
